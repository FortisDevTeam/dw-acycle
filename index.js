  ...
  try {
    if (process.env.ACTIVE == "TRUE") {
      for (let i = 0; i < auctions.length; i++) {
        ...
        console.log("Auction cycle count: ", auction_cycle_count);
        console.log("Stake cycle count: ", stake_cycle_count);
        ...
        console.log(
          "stake giveout with auction id ",
          auctions[i].auctionid,
          " and cycle count ",
          // auctions[i].stakecycle
          auction_cycle_count
        );
